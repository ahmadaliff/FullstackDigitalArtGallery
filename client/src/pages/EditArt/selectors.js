...
import { initialState as artDetailInitialState } from '@pages/EditArt/reducer';
...
const selectEditArtState = (state) => state.artEdit || artDetailInitialState;
export const selectArtEdit = createSelector(selectEditArtState, (state) => state.art);
